...
public class WeaponFactory {
    ...
    private static final Map<String, Weapon> weaponMap = Map.ofEntries(
            ...
            Map.entry("CROSSBOW", new Weapon("CROSSBOW", ElementType.GUN, 30, 30, 4, 30, new int[]{1, 8}, -1, 6, 6)),
            Map.entry("RUBBER_GUN", new Weapon("RUBBER_GUN", ElementType.GUN, 40, 15, 2, 15, new int[]{1, 6}, -1, 6, 8)),
            Map.entry("SHOTGUN", new Weapon("SHOTGUN", ElementType.GUN, 20, 45, 8, 45, new int[]{1, 2}, -1, 12, 4)),
